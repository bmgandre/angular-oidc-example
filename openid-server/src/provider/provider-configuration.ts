import { AdapterConstructor, Configuration, interactionPolicy } from 'oidc-provider';
...
export class ProviderConfiguration {
    ...
    getProviderConfiguration(): Configuration {
        ...
        configuration.interactions.policy = interactions;

        configuration.findAccount = Account.findAccount;

        configuration.adapter = this.adapterConstructor;
